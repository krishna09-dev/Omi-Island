...
//  OmiIsland
//
//  Central registry for built-in and user-provided notch themes.
//
...
struct ThemeDescriptor: Equatable, Identifiable {
    ...
    func previewIdleLabel(isChinese: Bool = false) -> String {
        previewIdleLabelEN
    }
}
...
final class ThemeRegistry: ObservableObject {
    ...
    func loadAll(pluginBundles: [Bundle]? = nil) {
        ...
        let resolvedBundles = pluginBundles ?? []
    ...
    private func userThemesDirectory() -> URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".config/omiisland/themes")
    }
