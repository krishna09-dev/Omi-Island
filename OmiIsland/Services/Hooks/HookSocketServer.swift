...
private let logger = Logger(subsystem: "dev.krishna09.omiisland", category: "Hooks")
...
class HookSocketServer {
    ...
    // Ephemeral IPC socket for hook events; recreated on each launch.
    static let socketPath = "/tmp/omiisland.sock"

    private var serverSocket: Int32 = -1
    private var acceptSource: DispatchSourceRead?
    private var eventHandler: HookEventHandler?
    private var permissionFailureHandler: PermissionFailureHandler?
    private let queue = DispatchQueue(label: "dev.krishna09.omiisland.socket", qos: .userInitiated)
