...
private let logger = Logger(subsystem: "dev.krishna09.omiisland", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "dev.krishna09.omiisland.interruptwatcher", qos: .userInteractive)
