...
struct NotchLiveEditOverlay: View {
    ...
    /// even on a notched MacBook Pro and the "snap to notch" button
    ...
    /// MacBooks, the software Omi-Island can be taller or shorter
    ...
    private func heightArrowButton(direction: Int, label: String) -> some View {
        ...
        // software Omi-Island can be taller or shorter than the
